...
10.times do  |index|    #cree 10 events
        Event.create!(title: "Event#{index}", description: Faker::ChuckNorris.fact, creator: User.all.sample, location: Faker::Address.full_address, price: rand(1..10)*5, duration: rand(1..10)*5, start_date: Faker::Date.forward(days: 100))
